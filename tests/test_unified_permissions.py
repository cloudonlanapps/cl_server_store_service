...
class TestEntityVsJobPermissions:
    ...
    def test_write_permission_allows_entity_but_not_job(self, auth_client, write_token, sample_image, sample_job_data):
    ...
    def test_inference_permission_allows_job_but_not_entity_write(self, auth_client, inference_token, sample_image, sample_job_data):
    ...
    def test_read_permission_allows_entity_read_but_not_write_or_job(self, auth_client, read_token, sample_job_data):
    ...
    def test_admin_permission_allows_both_entity_and_job(self, auth_client, admin_token, sample_image, sample_job_data):
...
class TestInferenceAdminPermissions:
    ...
    def test_inference_admin_can_access_job_endpoints(self, auth_client, inference_admin_token, sample_job_data):
    ...
    def test_inference_admin_can_access_admin_endpoints(self, auth_client, inference_admin_token):
    ...
    def test_inference_admin_cannot_write_entities(self, auth_client, inference_admin_token, sample_image):
...
class TestCombinedOperations:
    ...
    def test_entity_and_job_operations_are_independent(self, auth_client, write_token, inference_token, sample_image, sample_job_data):
    ...
    def test_demo_mode_allows_all_operations(self, client, sample_image):
        ...
        storage_response = client.get("/api/v1/admin/storage/size")
...
class TestPermissionHierarchy:
    ...
    def test_multiple_permissions_cumulative(self, jwt_token_generator, auth_client, sample_image, sample_job_data):
        ...
        multi_token = jwt_token_generator.generate_token(
            sub="multi_user",
            permissions=["media_store_read", "media_store_write", "ai_inference_support"],
            is_admin=False
        )
    ...
    def test_admin_overrides_all_restrictions(self, jwt_token_generator, auth_client, sample_image, sample_job_data):
